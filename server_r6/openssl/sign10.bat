...
set /a NT = %NT% + 1
set start=%time%
client -S %SN%  -H #s001234 -H #s001234 -H #s001234 -H #s001234 -H #s001234 -H #s001234 -H #s001234 -H #s001234 -H #s001234 -H #s001234 -H #?02 -s -p %PORT% -h  %IP%  -l  TLS13-AES128-CCM-SHA256
REM client -S %SN% -H  #s001234567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF  -H  #?02 -s -p %PORT% -h  %IP%  -l  TLS13-AES128-CCM-SHA256
set end=%time%

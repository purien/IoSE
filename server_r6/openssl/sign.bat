...
set /a NT = %NT% + 1
set start=%time%
REM client -S %SN% -H  #s001234567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF  -H  #! -s -p %PORT% -h  %IP%  -l  TLS13-AES128-CCM-SHA256
client -S %SN% -H  #s001234567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF  -H  #?02 -s -p %PORT% -h  %IP%  -l  TLS13-AES128-CCM-SHA256
set end=%time%
